...
function taskDataExtension(code, lang, escaped) {
...
module.exports.contentDataExtension = function (code, lang, callback){

  return require('./../../yaml-markdown-loader-extentions/contentDataExtension.js')
...
module.exports.taskDataExtension = taskDataExtension;
