...
module.exports.coursesPygmentHighlight = function (code, lang, callback){
        var extendedCodes = ['repl', 'editor', 'editor+repl', 'projecteditor+terminal'];
...
function replCodeExtension(code, lang, escaped) {
    ...
    switch (lang.toLowerCase()) {
      ...
      markup = '<div id="editor_'+ idSuffix
        ...
        + '\n</div>';
      break;
      case 'projecteditor+terminal':
      var data = splitByMeta(code);
      markup = '<div id="projecteditor_'+ idSuffix
        + '" class="projecteditor_terminal" data-meta="'+ escapeJson(JSON.stringify(data.meta)) +'">'
        + '\n</div>';
